...
def render_graph_ReSTIRGIaccum():
    ...
    ImageLoader = createPass('ImageLoader', {'outputSize': IOSize.Default, 'outputFormat': ResourceFormat.BGRA8UnormSrgb, 'filename': 'C:/Users/cappu/Documents/workspace/Falcor_2/Source/RenderPasses/Falcor-playground/Data/FreeBlueNoiseTextures/Data/1024_1024/LDR_RGBA_0.png', 'mips': False, 'srgb': True, 'arrayIndex': 0, 'mipLevel': 0})
